...
SELECT S.SUPP_NAME,S.SUPP_ID,COUNT(S.SUPP_ID), SP.PRO_ID FROM supplier AS S INNER JOIN supplier_pricing AS SP ON S.SUPP_ID GROUP BY S.SUPP_ID HAVING COUNT(S.SUPP_ID)>1;
